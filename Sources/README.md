...
[![Tech](https://img.shields.io/badge/Tech-.NET+10+%2f+WinUI+3-6366F1.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_STICKERS)
...
**STORM STICKERS** — компонент экосистемы **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
